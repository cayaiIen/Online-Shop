...
<c:forEach items="${listP}" var="o">
  ...
  <script>
    ...
    function load(cateid){
    	 $.ajax({
             url: "/WebsiteBanGamingGear/categoryShop",
    ...
    function searchByName(param){
        ...
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxShop",
            type: "get", //send it through get method
            data: {
                txt: txtSearch
            },
    ...
    function searchByPriceMinToMax(){
        ...
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxPriceMinToMax",
            type: "get", //send it through get method
            data: {
                priceMin: numMin,
                priceMax: numMax
    ...
    function searchByPriceUnder100(){
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxPriceUnder100Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPrice100To200(){
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxPrice100To200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPriceAbove200(){
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxPriceAbove200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorWhite(){
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxColorWhite",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorGray(){
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxColorGray",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorBlack(){
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxColorBlack",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorYellow(){
        $.ajax({
            url: "/WebsiteBanGamingGear/searchAjaxColorYellow",
            type: "get", //send it through get method
            data: {
