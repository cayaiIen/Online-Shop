...
<body onload="loadTotalMoney()">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            <a href="subAmountCart?productID=${o.productID}&amount=${o.amount}" 
                                                               onclick="return validateQuantityChange(${o.amount} - 1)">
                                                        ...
                                                        <td class="align-middle">
                                                            <a href="deleteCart?productID=${o.productID}" class="text-dark">
    ...
    <script>
        function loadTotalMoney() {
            $.ajax({
                url: "/WebsiteBanGamingGear/totalMoneyCart",
                type: "get",
        ...
        function validateQuantityChange(newAmount) {
