...
<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="position: fixed; top: 0; width:100%;  z-index: 100000;">
    <div class="container">
        <a href="#" class="logo">
            <img style="height: 70px" src="https://cdn.dribbble.com/users/5210526/screenshots/11732157/media/5eb235c1982d24ac3ffefdabf1e8003c.png" alt="">
        </a>
        <a class="navbar-brand" href="home">VNGear</a>
