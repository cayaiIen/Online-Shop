                    ...
                    <td>${o.name}</td>
                     ...
                     <td>${o.price} $</td>
                      <td>
                              ...
                              <a href="delete?pid=${o.id}"><button type="button" class="btn btn-danger" onclick="return confirm('Do you want to delete?')"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button></a>
                      </td>
                </tr>
                </c:forEach>
              </tbody>
