...
public class AddCartControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (amount <= 0 || amount > 10) {
            request.setAttribute("mess", "Quantity must be between 1 and 10.");
            request.getRequestDispatcher("managerCart").forward(request, response); // Replace "previousPage" with the appropriate page
            return;
        }
        DAO dao = new DAO();
